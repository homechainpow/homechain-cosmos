...
import (
	...
	"github.com/homechain/homechain/x/mining/keeper"
...
// AppModule represents an AppModule for the mining module
...
// ProvideAppModule provides the mining app module.
func ProvideAppModule(cdc codec.Codec, keeper keeper.Keeper) module.AppModule {
	return NewAppModule(cdc, keeper)
}

// ProvideAppModuleBasic provides the mining app module basic.
func ProvideAppModuleBasic(cdc codec.Codec) module.AppModuleBasic {
	return NewAppModuleBasic(cdc)
}

// ProvideKeeper provides the mining keeper.
func ProvideKeeper(cdc codec.Codec, storeKey storetypes.StoreKey, bankKeeper bankkeeper.Keeper, pohKeeper pohkeeper.Keeper) keeper.Keeper {
	return keeper.NewKeeper(cdc, storeKey, bankKeeper, pohKeeper)
}
...
// DepInject provides the dependency injection configuration for the mining module.
func DepInject(in DepInjectInputConfig) DepInjectOutputConfig {
	keeper := keeper.NewKeeper(in.AppCodec, in.StoreKey, in.BankKeeper, in.PoHKeeper)
